...
//           console.log(response.data, 'loanCharges')
...
//   const loanMis = async () => {
//     try {
//       const response = await HTTPRequest.loanMisStatus();
//       if (response.status === 200) {
//         // console.log(response.data,'MisLoan')
//       } else {
//         Alert.alert('Error', 'Failed to fetch loan MIS status.');
//       }
//     } catch (error) {
//       console.error('Error fetching loan MIS status:', error);
//       // Alert.alert('Error', 'An error occurred while fetching loan MIS status.');
//     }
//   };
      ...
      <View style={styles.container1}>
        <View style={styles.noLoanContainer}>
          <View style={styles.dottedBox}>
            ...
            />
            <Text style={styles.noLoanText}>You have No Notification</Text>
          </View>
        </View>
      </View>
</ScrollView>
